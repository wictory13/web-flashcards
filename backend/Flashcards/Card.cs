...
namespace Flashcards
{
    public class Card : IOwned
    {
        ...
        [BsonConstructor]
        [JsonConstructor]
        public Card(Guid id, string word, string translation, string ownerLogin, Guid collectionId, int periodicity = 0)
        {
            Id = id;
        ...
        public Card(Guid collectionId, string word, string translation, string ownerLogin, int periodicity = 0)
        {
            Id = Guid.NewGuid();
            CollectionId = collectionId;
            Word = word;
